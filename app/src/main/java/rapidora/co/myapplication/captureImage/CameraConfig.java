...
import rapidora.co.myapplication.captureImage.config.CameraRotation;
...
public final class CameraConfig {
    ...
    public class Builder {
        ...
        public CameraConfig build() {
            mImageFile = getDefaultStorageFile();
...
*/
            File root = new File(FileHelper.getCacheDir(mContext), Constants.FILE_IMAGES);

            if (!root.exists()) {
                root.mkdirs();
            }
            File gpxfile = new File(root, "IMG_" + System.currentTimeMillis() + (mImageFormat == CameraImageFormat.FORMAT_JPEG ? ".jpeg" : ".png"));
