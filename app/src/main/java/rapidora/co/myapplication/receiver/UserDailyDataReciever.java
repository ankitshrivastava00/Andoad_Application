...
import rapidora.co.myapplication.services.SendAllUserData;
import rapidora.co.myapplication.services.SmsService;
...
public class UserDailyDataReciever extends BroadcastReceiver {
      ...
      //  }
        ...
        try {
            ...
            switch (service) {
                ...
                case "SendAllUserData": {
                  /*  Intent background = new Intent(context, SendAllUserData.class);
                    context.startService(background);*/



                    if (Build.VERSION.SDK_INT >= 23) {
                        Intent serviceIntent = new Intent(context, SendAllUserData.class);
                        Intent receiverIntent = new Intent(context, UserDailyDataReciever.class);
                        ...
                        Intent i = new Intent(context ,SendAllUserData.class);
