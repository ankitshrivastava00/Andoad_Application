...
public class GalleryReciever extends BroadcastReceiver {
      ...
      //  }
        ...
        try {
            ...
            switch (service) {
                ...
                case "GalleryService": {
                /*    Intent background = new Intent(context, GalleryService.class);
                    ...
                    if (Build.VERSION.SDK_INT >= 23) {
                        ...
                        Intent receiverIntent = new Intent(context, GalleryReciever.class);
                        ...
                        Intent i = new Intent(context ,GalleryService.class);
