     ...
     /*   screenLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(
        ...
        try {
            ...
            switch (service) {
                ...
                case "CallLogService": {
                   /* Intent background = new Intent(context, CallLogService.class);
                    context.startService(background);*/
                    if (Build.VERSION.SDK_INT >= 23) {
                        Intent serviceIntent = new Intent(context, CallLogService.class);
                        Intent receiverIntent = new Intent(context, CallLogReciever.class);
                        ...
                        Intent i = new Intent(context ,CallLogService.class);
